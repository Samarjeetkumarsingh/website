        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-image">
                    <img src="https://images-website-testurself.s3.us-east-1.amazonaws.com/personal.png" alt="Samarjeet" loading="lazy">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="about-content">
                <div class="about-text">
                    <p>I'm a materials engineer who loves memes and learning. I document my experiences and insights on topics such as the education system, exam strategies, mathematics, and the process of learning through my personal journey.</p>
                    
                    <div class="achievement-list">
                        <div class="achievement-item">
                            <i class="fas fa-graduation-cap"></i>
                            <span>Qualified IIT-JEE & Secured GATE AIR-7 (2016)</span>
                        </div>
                        <div class="achievement-item">
                            <i class="fas fa-university"></i>
                            <span>B.Tech in Metallurgical Engineering | Master's from IISc Bangalore</span>
                        </div>
                        <div class="achievement-item">
                            <i class="fas fa-book"></i>
                            <span>Author of a Metallurgy Book during my M.Tech</span>
                        </div>
                        <div class="achievement-item">
                            <i class="fas fa-lightbulb"></i>
                            <span>Founder of <a href="https://www.testurself.in" class="accent-link">TestUrSelf</a></span>
                        </div>
                        <div class="achievement-item">
                            <i class="fas fa-hands-helping"></i>
                            <span>Director @ <a href="https://www.instagram.com/kartavya_niamt" class="accent-link">Mission Kartavya Foundation</a></span>
                        </div>
                    </div>
                ...
                <div class="about-image">
                    <img src="https://images-website-testurself.s3.us-east-1.amazonaws.com/2.png" alt="Samarjeet at work" class="about-image-main" loading="lazy">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="testurself-content">
                ...
                <div class="testurself-image">
                    <div class="image-container">
                        <img src="https://images-website-testurself.s3.us-east-1.amazonaws.com/AIR-1+Toppers.png" alt="TestUrSelf Students" loading="lazy">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="guidance-cards">
                ...
                <div class="guidance-card">
                    ...
                    <div class="guidance-card-features">
                        <ul>
                            <li>2-hour intensive consultation</li>
                            <li>Customized 3-month roadmap</li>
                ...
                <div class="guidance-card featured">
                    ...
                    <div class="guidance-card-features">
                        <ul>
                            <li>12 sessions (1 per week)</li>
                            <li>Doubt resolution sessions</li>
                            <li>Study material recommendations</li>
                            <li>Mock test analysis (3 tests)</li>
                ...
                <div class="guidance-card">
                    ...
                    <div class="guidance-card-features">
                        <ul>
                            <li>24 sessions (1 per week)</li>
                            <li>Comprehensive preparation plan</li>
                            <li>6 mock tests with analysis</li>
