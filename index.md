...
I am honored to announce that I have taken on the role of one of the Directors of **[Kartavya](https://www.missionkartavya.org){:target="_blank"}, Ranchi**. At Kartavya, we firmly believe that education can combat poverty and improve people's lives. **[Kartavya](https://www.missionkartavya.org){:target="_blank"}** is a non-profit organization that focuses on providing a comprehensive education to underprivileged students. Our mission is to provide a learning platform for students who lack access to quality education and to help them grow both academically and socially.

**[Kartavya](https://www.missionkartavya.org){:target="_blank"}** was established at NIAMT (formerly NIFFT) to address the need for educational support in the Hatia community.
